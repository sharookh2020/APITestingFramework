...
public class TestConfig{
	...
	public static String from = "sharookhtest1@gmail.com";
	public static String password = "Sharookhtest@123";
	public static String[] to ={"sharookhs26@gmail.com","sharookhtest2@gmail.com"};
